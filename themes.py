        ...
        if request.method == "GET":
            if path == '/' or not path:
                ...
                try:
                    ...
                    logging.error(
                        f"[{self.__class__.__name__}] on_webhook color error: {error}")
                    return
                ...
                try:
                    ...
                    logging.error(
                        f"[{self.__class__.__name__}] on_webhook faces error: {error}")
                    return
                ...
                try:
                    ...
                    logging.error(
                        f"[{self.__class__.__name__}] on_webhook led error: {error}")
                    return
            else:
                # unknown GET path
    ...
    def get_html(self):
        ...
        try:
            template_file = os.path.dirname(
                os.path.realpath(__file__)) + "/" + "themes.html"
