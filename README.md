# This is a list/collection of plugins for the pwnagotchi platform.
---
...
|apprise-notify.py|An Apprise plugin for pwnagotchi that implements all the available callbacks.|https://github.com/itsdarklikehell/pwnagotchi-plugins/blob/master/apprise-notify.py| | | |* removed| |
...
|away_base.py|Watches for known networks, connects for a while, then returns to recon|https://github.com/troystauffer/home_base|nope|https://github.com/nope| |*|link not from the original author|
...
|discohash.py|                    DiscoHash extracts hashes from pcaps (hashcat mode 22000) using hcxpcapngtool,
                    analyses the hash using hcxhashtool and posts the output to Discord along with                    any obtained GPS coordinates.|https://github.com/flamebarke/DiscoHash/blob/main/discohash.py|v0yager| |flamebarke| | |
...
|educational-purposes-exclusively.py|A plugin to automatically authenticate to known networks and perform internal network recon|https://github.com/MaliosDark/pwnagotchi-plugins/blob/main/educational-purposes-exclusively.py|MaliosDark| | | | |
|educational-purposes-only.py|A plugin to automatically authenticate to known networks and perform internal network recon|https://github.com/MaliosDark/pwnagotchi-plugins/blob/main/educational-purposes-only.py|MaliosDark| | | | |
...
|f0xtr0t.py|a plugin for pwnagotchi that shows a openstreetmap with positions of ap-handshakes in your webbrowser. Based on the origional webgpsmaps|https://github.com/sixt0o/f0xtr0t/blob/c52c138dfd85e884b21a7ca77f0f1558a710f3ce/f0xtr0t.py#L4|sixt0o| | | | |
|fake.py| | | | | | | |
|fancygotchi.py| | | | | | | |
|fancyserver.py| | | | | | | |
|fancytools.py| | | | | | | |
...
|hashie.py|Attempt to automatically convert pcaps to a crackable format.
                        If successful, the files  containing the hashes will be saved                        in the same folder as the handshakes.                        The files are saved in their respective Hashcat format:
                        ...
                        Why use it?:
                          - Automatically convert handshakes to crackable formats!                              We dont all upload our hashes online ;)
                        ...
                        Additional information:
                          ...
                          - Attempts to repair PMKID hashes when hcxpcaptool cant find the SSID
                            - hcxpcaptool sometimes has trouble extracting the SSID, so we                                use the raw 16800 output and attempt to retrieve the SSID via tcpdump
                            - When access_point data is available (on_handshake), we leverage                                the reported AP name and MAC to complete the hash
                        ...
                        Todo:
                          ...
                          Improve the code, a lot|https://github.com/evilsocket/pwnagotchi-plugins-contrib/blob/master/hashie.py|junohea.mail@gmail.com| | | | |
|hashieclean.py| | | | | | | |
...
|hp+educational-purposes.py|A combined Pwnagotchi plugin for setting up a honey pot and performing network authentication.|https://github.com/MaliosDark/pwnagotchi-plugins/blob/main/hp%2Beducational-purposes.py|MaliosDark| | | | |
|httpserver.py| | | | | | | |
...
|memtemp_ng.py| | | | | | | |
|memtemp-plus.py| | | | | | | |
|memtemp-plus.py (jayofelony)| |https://github.com/jayofelony/pwnagotchi-torch-plugins/blob/main/memtemp-plus.py|jayofelony| |xbits| | |
...
|pwnaget.py| | | | | | | |
|pwnassistant.py| | | | | | | |
|pwna-template-testing.py|Plugin to activate/deactivate the egirl-pwnagotchi theme|https://github.com/MaliosDark/pwnagotchi-plugins/blob/main/pwna-template-testing.py|MaliosDark| | | |DO NOT USE|
...
|pwnmenucmd.py| | | | | | | |
|pwnmenucmd.py (doki)| |https://github.com/do-ki/custom-plugins/blob/main/pwnmenucmd.py| | | | | |
|pwnmothership.py| | | | | | | |
|pwnspeaker.py| | | | | | | |
|pwnwatch.py| | | | | | | |
...
|ups_hat_c.py| | | | | | | |
|ups_lite_1_2.py|A plugin that will add a voltage indicator for the UPS Lite v1.1|https://github.com/Sliim/pwnagotchi-plugins/blob/master/ups_lite_1_2.py|Sliim| | | | |
|ups_lite_1_3.py|A plugin that will add a voltage indicator for the UPS Lite v1.1|https://github.com/Sliim/pwnagotchi-plugins/blob/master/ups_lite_1_3.py|Sliim| | | | |
|ups_lite_ng.py| | | | | | | |
|ups_lite.py| | | | | | | |
