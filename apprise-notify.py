...
class Apprise(plugins.Plugin):
    __author__ = "(edited by: itsdarklikehell bauke.molenaar@gmail.com), bauke.molenaar@gmail.com"
    __version__ = "1.0.0"
    __license__ = "GPL3"
    __description__ = (
    ...
    def on_free_channel(self, agent, channel):
        ...
        body = (
            "I just found a non overlapping wifi channel: " + channel + " that is free."
        )
        logging.debug(title + " " + short + " " + body)
        outputfile = "/tmp/" + short + ".wav"
    ...
    def on_wifi_update(self, agent, access_points):
        ...
        body = (
            "I have refreshed my list of access points. Access points: " + access_points
        )
        logging.debug(title + " " + short + " " + body)
        outputfile = "/tmp/" + short + ".wav"
    ...
    def on_unfiltered_ap_list(self, agent, access_points):
        ...
        body = (
            "I have refreshed my list of unfilteted access points. Access points: "
            + access_points
        )
        logging.debug(title + " " + short + " " + body)
        outputfile = "/tmp/" + short + ".wav"
    ...
    def on_epoch(self, agent, epoch, epoch_data):
        ...
        short = "on_epoch"
        body = (
            "I have completed a whole epoch. \nEpoch: "
            + epoch
            + "\nEpoch data: "
            + epoch_data
        )
