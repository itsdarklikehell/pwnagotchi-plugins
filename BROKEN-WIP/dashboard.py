...
class Dashboard(plugins.Plugin):
    ...
    __name__ = "Dashboard"
    __help__ = "Dashboard plugin is a consolidation of the clock, deauth counter, memtemp, pivoyager and added few features such as cracked handshake counter and internet status."
    ...
    def on_ui_setup(self, ui):
        ...
        ui.add_element(
            ...
            LabeledValue(
                ...
                value="",
                position=(
                    int(self.options["netstat_x_pos"]),
    ...
    def on_ui_update(self, ui):
        ...
        ui.set(
            "pivoyager",
            "{sbat}{voltage}".format(
                sbat=charge_mapping[status["bat"]], voltage=status["vbat"]
            ),
        )
