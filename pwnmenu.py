    ...
    def on_loaded(self):
        ...
        while self.running:
            ...
            if msg == "down":
                ...
                if (
                    self.menuitem == (menuitemcount - 1)
                    or (self.menuitem % self.labelcount) == 0
                ):
                    self.updatelabels = True
            ...
            self.showdownarrow = (menuitemcount - self.menuitem) > (
                menuitemcount % self.labelcount
            )
                ...
                if self.uihardware == "displayhatmini":
                    if view.ROOT:
                        view.ROOT.add_element(
                            "menubg", FilledRect(self.rectfill, color=WHITE)
                        )
                        view.ROOT.add_element(
                            "menuborder", Rect(self.rectfill, color=BLACK)
                        )
                        view.ROOT.add_element(
        ...
        if self.menuvisible:
            if self.updatelabels:
                ...
                if self.uihardware == "displayhatmini":
                    ...
                    menuitem_text1 = (
                        menulabels[menuoffset + 1]
                        if menuoffset + 1 < menuitemcount
                        else " "
                    )
                    menuitem_text2 = (
                        menulabels[menuoffset + 2]
                        if menuoffset + 2 < menuitemcount
                        else " "
                    )
                    menuitem_text3 = (
                        menulabels[menuoffset + 3]
                        if menuoffset + 3 < menuitemcount
                        else " "
                    )
                    menuitem_text4 = (
                        menulabels[menuoffset + 4]
                        if menuoffset + 4 < menuitemcount
                        else " "
                    )
                    menuitem_text5 = (
                        menulabels[menuoffset + 5]
                        if menuoffset + 5 < menuitemcount
                        else " "
                    )
