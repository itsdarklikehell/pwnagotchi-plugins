...
class Slack(plugins.Plugin):
    ...
    __version__ = '1.0.0'
    __license__ = 'GPL3'
    __description__ = 'Post recent activity to a Slack using webhooks. Requires slackclient module.'
    ...
    def on_internet_available(self, agent):
        ...
        if last_session.is_new() and last_session.handshakes > 0:
            ...
            logging.info("Slack: detected new activity and internet, time to send a message!")
            ...
            try:
                ...
                sc = WebClient(token)
                sc.files_upload(channels=channel,file=picture, title=title_, filetype='png')
