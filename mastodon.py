    ...
    def on_internet_available(self, agent):
        ...
        if last_session.is_new() and last_session.handshakes > 0:
            ...
            try:
                ...
                mastodon = Mastodon(client_id=client_cred, api_base_url=api_base_url)
                mastodon.log_in(email, password, to_file=user_cred)
                mastodon = Mastodon(access_token=user_cred, api_base_url=api_base_url)
